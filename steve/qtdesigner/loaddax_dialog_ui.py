...
#
# Created: Thu Jun 04 10:14:09 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.frame_label = QtGui.QLabel(Dialog)
        self.frame_label.setObjectName(_fromUtf8("frame_label"))
        self.gridLayout.addWidget(self.frame_label, 4, 0, 1, 1)
        self.frame_spin_box = QtGui.QSpinBox(Dialog)
        self.frame_spin_box.setObjectName(_fromUtf8("frame_spin_box"))
        self.gridLayout.addWidget(self.frame_spin_box, 5, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.frame_label.setText(_translate("Dialog", "Frame", None))
