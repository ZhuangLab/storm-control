...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 200, 191))
        ...
        self.liveModeGroupBox = QtGui.QGroupBox(self.paramsWidget)
        self.liveModeGroupBox.setObjectName(_fromUtf8("liveModeGroupBox"))
        self.verticalLayout = QtGui.QVBoxLayout(self.liveModeGroupBox)
        self.verticalLayout.setMargin(2)
        self.verticalLayout.setSpacing(2)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.horizontalLayout_8 = QtGui.QHBoxLayout()
        self.horizontalLayout_8.setObjectName(_fromUtf8("horizontalLayout_8"))
        self.liveModeCheckBox = QtGui.QCheckBox(self.liveModeGroupBox)
        self.liveModeCheckBox.setChecked(True)
        self.liveModeCheckBox.setObjectName(_fromUtf8("liveModeCheckBox"))
        self.horizontalLayout_8.addWidget(self.liveModeCheckBox)
        self.verticalLayout.addLayout(self.horizontalLayout_8)
        self.verticalLayout_4.addWidget(self.liveModeGroupBox)
        self.mosaicGroupBox_2 = QtGui.QGroupBox(self.paramsWidget)
        self.mosaicGroupBox_2.setObjectName(_fromUtf8("mosaicGroupBox_2"))
        self.verticalLayout_6 = QtGui.QVBoxLayout(self.mosaicGroupBox_2)
        self.verticalLayout_6.setMargin(2)
        self.verticalLayout_6.setSpacing(2)
        self.verticalLayout_6.setObjectName(_fromUtf8("verticalLayout_6"))
        self.horizontalLayout_12 = QtGui.QHBoxLayout()
        self.horizontalLayout_12.setObjectName(_fromUtf8("horizontalLayout_12"))
        self.objectiveLabel_2 = QtGui.QLabel(self.mosaicGroupBox_2)
        self.objectiveLabel_2.setObjectName(_fromUtf8("objectiveLabel_2"))
        self.horizontalLayout_12.addWidget(self.objectiveLabel_2)
        self.objectiveText_2 = QtGui.QLabel(self.mosaicGroupBox_2)
        self.objectiveText_2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.objectiveText_2.setObjectName(_fromUtf8("objectiveText_2"))
        self.horizontalLayout_12.addWidget(self.objectiveText_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.liveModeGroupBox.setTitle(_translate("MainWindow", "Live Mode", None))
        self.liveModeCheckBox.setText(_translate("MainWindow", "Run Live Mode", None))
        self.mosaicGroupBox_2.setTitle(_translate("MainWindow", "Mosaic", None))
        self.objectiveLabel_2.setText(_translate("MainWindow", "Objective:", None))
        self.objectiveText_2.setText(_translate("MainWindow", "asdf", None))
