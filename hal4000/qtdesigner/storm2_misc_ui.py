...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.emFilter1Button.setGeometry(QtCore.QRect(10, 20, 31, 24))
        ...
        self.emFilter2Button.setGeometry(QtCore.QRect(45, 20, 31, 24))
        ...
        self.emFilter3Button.setGeometry(QtCore.QRect(80, 20, 31, 24))
        ...
        self.emFilter4Button.setGeometry(QtCore.QRect(115, 20, 31, 24))
        ...
        self.emFilter5Button.setGeometry(QtCore.QRect(150, 20, 31, 24))
        ...
        self.emFilter6Button.setGeometry(QtCore.QRect(185, 20, 31, 24))
        ...
        self.emFilter7Button = QtGui.QPushButton(self.emGroupBox)
        self.emFilter7Button.setGeometry(QtCore.QRect(220, 20, 31, 24))
        self.emFilter7Button.setCheckable(True)
        self.emFilter7Button.setAutoExclusive(True)
        self.emFilter7Button.setObjectName(_fromUtf8("emFilter7Button"))
        self.emFilter8Button = QtGui.QPushButton(self.emGroupBox)
        self.emFilter8Button.setGeometry(QtCore.QRect(255, 20, 31, 24))
        self.emFilter8Button.setCheckable(True)
        self.emFilter8Button.setAutoExclusive(True)
        self.emFilter8Button.setObjectName(_fromUtf8("emFilter8Button"))
        self.emFilter9Button = QtGui.QPushButton(self.emGroupBox)
        self.emFilter9Button.setGeometry(QtCore.QRect(290, 20, 31, 24))
        self.emFilter9Button.setCheckable(True)
        self.emFilter9Button.setAutoExclusive(True)
        self.emFilter9Button.setObjectName(_fromUtf8("emFilter9Button"))
        self.emFilter10Button = QtGui.QPushButton(self.emGroupBox)
        self.emFilter10Button.setGeometry(QtCore.QRect(325, 20, 31, 24))
        self.emFilter10Button.setCheckable(True)
        self.emFilter10Button.setAutoExclusive(True)
        self.emFilter10Button.setObjectName(_fromUtf8("emFilter10Button"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.emFilter7Button.setText(_translate("Dialog", "7", None))
        self.emFilter8Button.setText(_translate("Dialog", "8", None))
        self.emFilter9Button.setText(_translate("Dialog", "9", None))
        self.emFilter10Button.setText(_translate("Dialog", "10", None))
